...
export function createActionButtonsPrompt(): string {
  return rejectFalsyItems([
    ...
    'WHEN TO ADD BUTTONS:',
    '1. Only for responses longer than 4-5 sentences',
    '2. When the topic naturally branches into specific sub-topics',
    '3. When there are clear, valuable follow-up points',
    '4. When exploring complex concepts with multiple aspects',
    '',
    'WHEN TO SKIP BUTTONS:',
    '1. Short, direct answers',
    '2. Simple confirmations or clarifications',
    '3. Technical fixes or corrections',
    '4. When the topic is fully addressed',
    '5. For yes/no responses',
    '6. When there are no natural follow-up points',
    '',
